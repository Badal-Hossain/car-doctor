    ...
    return (
        <div className=" my-16">
            ...
            <div className="grid grid-cols-6 my-6 px-20">
                <div className="col-span-1 animate-pulse border-2 py-5 w-2/3 text-center mx-auto">
                    <RiTeamFill className="mx-auto text-center text-3xl"></RiTeamFill>
                    <p className="text-sm">Expert Team</p>
                </div>
                <div className="col-span-1 animate-bounce border-2 py-5 w-2/3 text-center mx-auto text-white bg-red-600">
